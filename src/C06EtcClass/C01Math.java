...
public class C01Math {
    public static void main(String[] args) {    //Math의 static메서드
////        Math.random() : 임의수 반환. 0.0~1.0사이의 double반환(실수)
//        System.out.println(Math.random());
////        로또번호7개 뽑기. 0~99까지 임의 숫자
//        for (int i = 0; i < 7; i++) {
...
//        System.out.println(Math.ceil(5.7));     //6.0  -> 리턴타입 더블

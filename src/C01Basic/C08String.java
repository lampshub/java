...
//        이메일 검증
//        String email = "abc1234@naver.csom";
...
//        String[] arr = {"java","puthon","javascript"};
...
//        예를 들어, 쓰레드A 가 appen("hello") 쓰레드B가 append("world")
//        이 두작업이 중산에 섞여 "heworlllo" 이런식으로 잘못된 값으르 만들수 있음

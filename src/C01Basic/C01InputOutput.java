...
//        출력 : System.out 을 통해 콘솔(터미너창)출력
//        System.out.println(20); //1)println : 줄바꿈 있는 출력. 2)입출력은 모두 문자열로 진행
...
//        입력2 : BufferedReader : 1) 버퍼를 활용하여 더 좋은 성능 2) InputStreamReader 는 바이트대신 문자단위로 입력
...
//        close() 는 메모리회수. 외부입출력장치와 연계된 코드이므로, GC의 대상이 아님. 안해도 되지만 회수를 권고.
//        G.C(garbage collecter) 가 다 해줌 (java프로그램 내에 해당하는 것들만(변수))
//        br.close();

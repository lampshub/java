...
//        예외처리 목적 : **1) 사용자에게 적절한 에러 메시지 전달 2) 예외 발생 시 디버깅을 위한 로그 기록
...
//        catch를 통해 예상 되는 예외 클래스를 분기 처리한다.
...
//      예외처리를 하지 않을경우 프로그램은 강제종료, try catch를 통한 예외처리를 할 경우 프로그램은 예외가 발생하더라도 지속

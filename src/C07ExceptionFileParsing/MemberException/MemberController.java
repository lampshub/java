...
public class MemberController {
    public static void main(String[] args) {
        ...
        C07ExceptionFileParsing.MemberException.MemberService memberService = new MemberService();
        while (true){
...
//                사용자의 입력값 단순검증 (Service에서 예외던지지 않고, Controller에서 바로 검증)
...
//                회원상세조회시 발생하는 예외를 적절히 try/catch
                try{
                    ...
                    System.out.println(e.getMessage()); //service에서 던진 "없는 사용자입니다" tkdyd
                    e.printStackTrace();
                }
